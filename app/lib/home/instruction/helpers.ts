...
export function buildInstructionEnhanceMessage(options: {
  ...
  return [
    ...
    "    Remove contradictions, ambiguity, redundancy, and clear typos while preserving intended meaning and guardrails.",
    "  </primary_objective>",
    "  <requirements>",
    "    <rule>Preserve as much original information as possible; avoid deleting details unless necessary.</rule>",
    "    <rule>Do not omit, summarize, or truncate sections. Keep all important details and examples.</rule>",
    "    <rule>Do not add placeholder comments/markers such as '省略', 'omitted', 'same as original', or equivalent.</rule>",
    "    <rule>Correct clear typos and spelling mistakes without changing intended meaning.</rule>",
    ...
    "    <rule>Before output, verify schema validity and patch consistency.</rule>",
