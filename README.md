...
- `server-git` (`npx -y @modelcontextprotocol/server-git`)
- `server-http` (`npx -y @modelcontextprotocol/server-http`)
- `server-sqlite` (`npx -y @modelcontextprotocol/server-sqlite`)
- `server-postgres` (`npx -y @modelcontextprotocol/server-postgres`)
- `server-memory` (`npx -y @modelcontextprotocol/server-memory`)
- `server-shell` (`npx -y @modelcontextprotocol/server-shell`)
- `server-playwright` (`npx -y @modelcontextprotocol/server-playwright`)
